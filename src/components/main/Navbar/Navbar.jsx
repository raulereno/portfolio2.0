...
const Navbar = ({ showNav, setShowNav, leng_nav }) => {
        ...
        <ul>
          ...
          >
            <a href="#container_landing">
              ...
              <span className="home">{leng_nav.home}</span>
            </a>
          </li>
          <li
            onClick={() => setShowNav()}
          ...
          >
            <a href="#container_portfolio">
              ...
              <span className="portfolio">{leng_nav.portfolio}</span>
            </a>
          </li>
          <li
            onClick={() => setShowNav()}
          ...
          >
            <a href="#container_resume">
              ...
              <span className="resumen">{leng_nav.resume}</span>
            </a>
          </li>
          <li
            onClick={() => setShowNav()}
          ...
          >
            <a href="#container_about">
              ...
              <span className="about">{leng_nav.about}</span>
            </a>
          </li>
          <li
          ...
          >
            <a href="#container_contact">
              ...
              <span className="contact">{leng_nav.contact}</span>
            </a>
          </li>
        </ul>
      </nav>
